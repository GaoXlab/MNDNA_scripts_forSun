...
# ggsave('../../Figure/Fig6/Anno1_SeuratClusters_withoutAnnotation.pdf', p1, width=7, height=5)
...
# ggsave('../../Figure/Fig6/Anno2_SeuratClusters_withoutAnnotation.dotplot.pdf', p1, width=11, height=6)
...
ggsave('../../Figure/Fig6/Fig6b.SeuratClusters_withAnnotation.pdf', p_cellanno, width=6, height=4)
...
# ggsave('../../Figure/Fig6/Anno2_SeuratClusters_withAnnotation.dotplot.pdf', p1, width=10, height=4)
...
p2 <- cellnumber_summary(immune.combined, sample_labels, sample_groups, celltypes, colors, 'BM')

g <- plot_grid(p1,p2,ncol=1,rel_heights=c(1.5,1))
ggsave('../../Figure/Fig6/FigS14.BM.pdf', g, width=8, height=7.5)
...
write.table(cbind(immune.combined@meta.data, immune.combined@ reductions$ umap@ cell.embeddings), './Supplementarytables_immune.combined.log', sep='\t')
