...
feature_bed = read.table(str_c('feature/', filename), sep='\t', head=T); feature_bed = feature_bed[, c('chr','start','end')]
...
feature_bed = read.table(str_c('feature/', filename), sep='\t', head=T)
