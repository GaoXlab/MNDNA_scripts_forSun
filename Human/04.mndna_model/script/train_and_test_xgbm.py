...
if __name__ == "__main__":
    ...
    xgbm = XGBClassifier(learning_rate=0.1, n_estimators=190, max_depth=3, min_child_weight=1, \
                                  seed=1234, subsample=1, colsample_bytree=1, gamma=0.7, reg_alpha=1, reg_lambda=1, n_jobs=12)
