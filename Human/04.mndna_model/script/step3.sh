...
#$SCRIPT_DIR/make_all_tab.sh manu_${TYPE}_240103 all.manu_${TYPE}_240103.tab
...
# merge output.[1-40] to manu_${TYPE}_240103.bed
php $SCRIPT_DIR/merge_p80_rfe_result.php "$TYPE" $MODEL_DATA_DIR/"${TYPE}_p80_ids.txt" > $FEATURE_REDUCTION_OUTPUT_DIR/manu_"${TYPE}"_240103.bed
